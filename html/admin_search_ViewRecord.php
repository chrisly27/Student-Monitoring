...
<header>
		...
		<h2 class="full"><a href="admin.php" class="btnbutton">Back</a></h2>
</header>
...
<div id="container">
	...
	<?php 
		...
		$query = mysql_query(
								...
								`SM_Student`.`Student_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Student`.`Student_Middle_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Student`.`Student_Surname` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Student`.`Student_Email` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Project`.`Project_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Course`.`Course_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Supervisor`.`Supervisor_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Department`.`Department_Name` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Department`.`Department_Leader` LIKE '%" . $_POST['search'] . "%' OR							
								`SM_Meeting`.`Action` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Issues` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Progress` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Cur_Date` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Outcome` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Reasons` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Meeting_Did_Not_Take_Place` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Other_Reasons` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Other_Supervisor_Present` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Interin_Date` LIKE '%" . $_POST['search'] . "%' OR
								`SM_Meeting`.`Monthly_Date` LIKE '%" . $_POST['search'] . "%'
